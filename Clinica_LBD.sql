...
EXEC PACKCONTACTO.SP_ELIMINAR_CONTACTO;
--Paquete funciones de Contacto
CREATE OR REPLACE PACKAGE PACKCONTACTO
AS
    --SP
    PROCEDURE SP_ELIMINAR_CONTACTO;
...
AS
    ...
    --SP 
    PROCEDURE SP_ELIMINAR_CONTACTO AS 
        v_sql VARCHAR(200); 
    BEGIN 
        v_sql := 'DELETE FROM CONTACTO'; 
...
BEGIN 
    PACKCONTADO.SP_ELIMINAR_CONTACTO;
END;
EXEC SP_ELIMINAR_CONTACTO;
