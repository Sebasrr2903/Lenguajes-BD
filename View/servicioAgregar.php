...
<body>
   ...
   <div class="contact_section layout_padding">
      <div class="container">
         <h2 class="health_taital">Agregar Servicio</h2>
               ...
               <div class="col-md-6">
                  <div class="contact_box">
                     <form action="" method="post">
                        ...
                        <input type="text" class="Email_text" placeholder="Id del Servicio" name="IdServi">
                        ...
                        <div style="text-align: center; padding: 10px;">
                           <button type="submit" class="btn btn-outline-info btn-lg px-5"
                              ...
                              name="agregarServicio"><a style="color: white;">Confirmar</a></button>
                        </div>
                     </form>
