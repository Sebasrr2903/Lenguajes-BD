...
function Navbar() {
  ...
  // Verifica si el usuario ha iniciado sesión y su rol es 'admin'
  ...
  // Verifica si el usuario ha iniciado sesión para mostrar el enlace de Logout
  if (isset($_SESSION['user_id'])) {
      ...
      // Si el usuario no ha iniciado sesión, muestra el enlace "Login"
      echo '
      <ul class="navbar-nav ml-auto">
         <li class="nav-item">
            <a class="nav-link" href="login.php">Login</a>
