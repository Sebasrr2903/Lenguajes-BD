            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="icon_main">
                     ...
                     <h4 class="diabetes_text">Agregue la informacion paciente</h4>
                  </div>
                  <div class="icon_main">
               ...
               <div class="col-md-6">
                  <div class="contact_box">
                     <form action="" method="post">
                        <h1 class="book_text">Agregue la información del paciente</h1>
                        ...
                        <div style="text-align: center; padding: 10px;">
                           <button type="submit" class="btn btn-outline-info btn-lg px-5"
                              ...
                              name="agregarPaciente"><a style="color: white;">Confirmar</a></button>
                        </div>
                     </form>
