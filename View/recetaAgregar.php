...
<body>
   ...
   <div class="contact_section layout_padding">
      <div class="container">
         <h2 class="health_taital">Agregar Recetas</h2>
         <div class="news_section_2">
            <div class="row">
               <div class="col-md-6">
                  <div class="icon_main">
                     <div class="icon_7"><img src="images/icon-7.png"></div>
                     <h4 class="diabetes_text">Agregue la informacion Receta</h4>
                  </div>
                  <div class="icon_main">
                     <div class="icon_7"><img src="images/icon-5.png"></div>
                     <h4 class="diabetes_text">verifica la informacion del Receta</h4>
                  </div>
                  <div class="icon_main">
               ...
               <div class="col-md-6">
                  <div class="contact_box">
                     <form action="" method="post">
                        <h1 class="book_text">Agregue la información de la Receta</h1>
                        ...
                        <div style="text-align: center; padding: 10px;">
                           <button type="submit" class="btn btn-outline-info btn-lg px-5"
                              ...
                              name="agregarReceta"><a style="color: white;">Confirmar</a></button>
                        </div>
                     </form>
